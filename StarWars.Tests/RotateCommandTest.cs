...
public class AngleTests
{
    ...
    public void Value_NumeratorIsMax_Returns360()
    {
        ...
        Assert.Equal(exp, angle.Value); // В зависимости от логики, может быть другое значение
    }
    ...
    public void Value_NumeratorIsMin_Returns360()
    {
        ...
        Assert.Equal(int.MinValue % 8, angle.Value); // В зависимости от логики, может быть другое значение
    }
}
